...
export const faqs: Faq[] = [
    {
        ...
        a: "Zehbee's AI Prompt Generator is a free, no-signup tool that creates highly optimized prompts for image and text models right in your browser.",
    },
    {
        q: "How do I compress images without losing quality?",
        a: "Use Zehbee's AI Image Compressor to smartly reduce file sizes while retaining visual quality. Completely free, no account needed.",
    },
    {
        q: "How do I convert images online for free?",
        a: "Use Zehbee's Image Converter to convert between PNG, JPG, WEBP, and more — completely free, no account needed, right in your browser.",
    },
    {
        q: "Is the AI Caption Generator free to use?",
        a: "Yes. Zehbee's AI Caption Generator is 100% free. Upload your image and get smart, engaging captions generated by AI instantly.",
    },
    {
        q: "Can I generate a QR code for free?",
        a: "Absolutely. Our QR Code Generator lets you create QR codes for any URL, text, or contact info — free forever with instant download.",
    },
    {
        q: "Do I need to create an account to use these tools?",
        a: "No signup, no account, no email required. All tools on Zehbee are free and work instantly in your browser.",
    },
];